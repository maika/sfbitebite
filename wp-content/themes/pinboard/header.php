...
<link rel="shortcut icon" href="<?php bloginfo('stylesheet_directory'); ?>/fork_knife-favi.png" />
...
<script>
  window.fbAsyncInit = function() {
    // init the FB JS SDK
    FB.init({
      appId      : '219895948150079', // App ID from the App Dashboard
      channelUrl : '//sfbitebite.com/channel.html', // Channel File for x-domain communication
